...
CubicCrossLinkedOctree::CubicCrossLinkedOctree(PlyVertexList const& point_list)
{
...
tuple<tuple<double, double>, tuple<double, double>, tuple<double, double>> CubicCrossLinkedOctree::find_boundry(PlyVertexList const& point_list)
{
    ...
    return { {(*x_min).X(), (*x_max).X()}, {(*y_min).Y(), (*y_max).Y()}, {(*z_min).Z(), (*z_max).Z()} };
}

double CubicCrossLinkedOctree::find_max_range(tuple<tuple<double, double>, tuple<double, double>, tuple<double, double>> const& boundries) const
{
    double x_range_min, x_range_max, y_range_min, y_range_max, z_range_min, z_range_max;
    tuple<double, double> x_range, y_range, z_range;
    tie(x_range, y_range, z_range) = boundries;
